...
import login from '../images/awesome.svg'
                ...
                <div className="row">
                    <div className="col-md-6 d-flex flex-column justify-content-center">
                        ...
                        <div className="d-flex justify-content-center mt-3">
                            <Button component={Link} to="/" variant="contained" color="secondary" style={{ color: "White", textTransform: "none", fontFamily: "'Poppins', sans-serif", fontSize: "1.3rem" }}>Create New Note</Button>
                        </div>
                    </div>
